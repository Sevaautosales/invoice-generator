...
export default function InvoicePreview({ data }: InvoicePreviewProps) {
    ...
    return (
        <Card id="invoice-capture-area" className="w-full max-w-[850px] mx-auto bg-white border-0 shadow-2xl print:shadow-none print:border-0 print:p-0 print:m-0 print:max-w-none overflow-hidden font-sans text-gray-900 mb-20 p-4 sm:p-8 relative print:bg-white" style={{ color: colors.gray900 }}>
            <CardContent className="p-0 border flex flex-col print:border-0 print:min-h-0" style={{ borderColor: colors.gray100, minHeight: '1050px' }}>
                ...
                <div className="flex justify-between items-start mb-4 px-8 pt-6">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest" style={{ color: colors.gray400 }}>ORIGINAL FOR RECIPIENT</span>
                </div>
                    ...
                    <div className="space-y-4 flex-1">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-[9px] font-bold uppercase tracking-[0.2em] mt-1" style={{ color: colors.gray400 }}>Professional Vehicle Modifications</p>
                            </div>
                        </div>
                        ...
                        <div className="text-[10px] font-bold leading-relaxed uppercase space-y-1" style={{ color: colors.gray500 }}>
                            ...
                            <div className="grid grid-cols-1 gap-1 text-[9px] pt-2 border-t" style={{ borderColor: '#f9fafb' }}>
                                <p><span style={{ color: 'rgba(0,0,0,0.4)' }}>Work:</span> Street No. 14, Ghanshyam Nagar Soc., Opp. New Shaktivijay, L.H. Road, SURAT.</p>
                                <div className="flex gap-4">
                                    <p><span style={{ color: 'rgba(0,0,0,0.4)' }}>Email:</span> <span className="lowercase" style={{ color: colors.black }}>sevaautosales@gmail.com</span></p>
                                    <p><span style={{ color: 'rgba(0,0,0,0.4)' }}>Web:</span> <span className="lowercase" style={{ color: colors.black }}>sevaautosales.vercel.app</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-2 gap-0 border-t border-b mx-8 py-6 mb-8" style={{ borderColor: colors.gray100, backgroundColor: 'rgba(249, 250, 251, 0.3)' }}>
                    <div className="space-y-4 pr-8">
                        ...
                        <div className="space-y-1">
                            ...
                            {data.customer_phone && <p className="text-[11px] font-bold" style={{ color: colors.gray600 }}>Ph: {data.customer_phone}</p>}
                        </div>
                    </div>
                    <div className="space-y-4 pl-8 border-l" style={{ borderColor: colors.gray100 }}>
                        ...
                        <div className="space-y-1">
                            ...
                            <div className="text-[11px] font-bold uppercase" style={{ color: colors.gray600 }}>
                ...
                <div className="mx-8 mb-8 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-8 text-[11px] font-bold uppercase leading-relaxed" style={{ color: colors.gray600 }}>
                        <div className="space-y-1">
                ...
                {/* Table Rows */}
                <div className="mx-8 mb-6 divide-y" style={{ borderColor: colors.gray100 }}>
                    {data.items.map((item, idx) => (
                        <div key={idx} className="grid grid-cols-12 py-5 items-start">
                            ...
                            <div className="col-span-5 pr-4">
                                ...
                                <p className="text-[10px] font-bold uppercase leading-tight mt-1.5 opacity-70" style={{ color: colors.gray400 }}>
                ...
                <div className="mx-8 mb-12 flex flex-col items-end border-t pt-6" style={{ borderColor: colors.gray100 }}>
                    ...
                    <div className="text-right">
                        ...
                        <p className="text-[11px] font-black uppercase italic max-w-sm ml-auto" style={{ color: colors.gray900 }}>
                            {amountInWords}
                        </p>
                    </div>
                </div>
                ...
                <div className="mx-8 grid grid-cols-2 gap-8 items-end mb-12">
                    <div className="space-y-4">
                        {data.notes && (
                            <div className="p-3 rounded-xl border" style={{ backgroundColor: 'rgba(14, 165, 233, 0.05)', borderColor: 'rgba(14, 165, 233, 0.1)' }}>
                                <p className="text-[10px] font-black uppercase tracking-widest mb-1" style={{ color: colors.theme }}>Notes:</p>
                                <p className="text-[11px] font-black uppercase italic leading-relaxed" style={{ color: colors.gray900 }}>{data.notes}</p>
                            </div>
                        )}

                        {/* Terms and Conditions inside footer meta *) */}
                        <div className="p-4 rounded-xl border" style={{ backgroundColor: 'rgba(249, 250, 251, 0.5)', borderColor: colors.gray100 }}>
                            ...
                            <div className="space-y-1">
                                {[
                                    ...
                                    <div key={i} className="flex gap-2">
                                        ...
                                        <span className="text-[8px] font-bold uppercase" style={{ color: colors.gray500 }}>{term}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
                    ...
                    <div className="text-right flex flex-col items-end pt-4">
                        <div className="relative text-right mb-0">
                            <p className="text-[12px] font-black uppercase mb-12" style={{ color: '#1a110d' }}>For Seva Auto Sales</p>
                            <div className="w-48 h-px ml-auto" style={{ backgroundColor: colors.gray200 }} />
